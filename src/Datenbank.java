...
public class Datenbank implements Serializable {
    ...
    public static ArrayList<Rezepte> Rezepte_dateiaufruf_normal() {
        try {
            ...
            while (s.hasNextLine()) {
                Rezepte normal = new Rezepte(s.next(),s.nextLine(), Double.parseDouble(s.next()),s.nextLine());
    ...
    public static ArrayList<Rezepte> Rezepte_dateiaufruf_vegetarisch() {
        try {
            ...
            while (s.hasNextLine()) {
                Rezepte vegetarisch = new Rezepte(s.next(),s.nextLine(), Double.parseDouble(s.next()),s.nextLine());
    ...
    public static ArrayList<Rezepte> Rezepte_dateiaufruf_vegan() {
        try {
            ...
            while (s.hasNextLine()) {
                Rezepte vegan = new Rezepte(s.next(), s.nextLine(),Double.parseDouble(s.next()),s.nextLine());
